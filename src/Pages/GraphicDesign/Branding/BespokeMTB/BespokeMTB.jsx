        ...
        <div className="bmtb_parent">
          ...
          <div className="bmtb_info">
            <div className="bmtb_clientBrief">
              ...
              <span>
                ...
                <div>
                  <p>
                    Logo needs to look good and be readable in small spaces.
                  </p>
                  <p>Bold Typography - Sans Serif?</p>
                  <p>To be printed on bikes.</p>
                  <p>
                    Interested in using when making apparel in future for
          ...
          <div className="bmtb_sketches">
            ...
            <div>
              ...
              <p>
                ...
                can see at the top of the page, but unfortunately does not make
                a good icon.
                <br />
                ...
                especially given that the client builds custom Mountain Bikes
                for their customers.
              </p>
            </div>
          </div>
          <div className="bmtb_ill_ideas">
            ...
            <div>
              ...
              <p>
                I took some of my preferred sketches and started translating
                them into Illustrator. I wasn't ready yet to give up on the idea
                with the tyre, so had to test it out but came to the conclusion
                that this would not look sleek enough for the brand.
                <br />
                Next I started to play around with some of the lettering to see
                if I could use part of it to make it look like bike pedals,
                giving imagery back to the brand. Unfortunately I couldn't come
                up with a design that I thought would work well, so left this as
                just an experiment.
                <br />
